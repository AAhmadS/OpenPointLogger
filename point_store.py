...
class Store:
    ...
    def _save(self):
        with self._lock:
            ...
            tmp.write_text(json.dumps({"topics": self._topics}, ensure_ascii=False, indent=2),
                           encoding="utf-8")
...
<header><div class="kicker">OpenPointLogger · Research Notes</div>
<h1>__TITLE__</h1>
...
<footer>Generated by OpenPointLogger · Log the point. Keep the source.</footer>
</div></body></html>"""
    ...
    def _render_md(self, t, entries, refs, folder):
        ...
        lines.append("")
        lines.append("---")
        lines.append("_Generated by OpenPointLogger — Log the point. Keep the source._")
        return "\n".join(lines)